...
To build sustainable, general-purpose software infrastructure for the neuroscience community
...
![TUI: Terminal User Interface | Works cross-platform, including on HPC](img/datashuttle-tui-transfer.png){fig-align=left}
